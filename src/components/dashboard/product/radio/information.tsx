...
const Information = ({ form }: { form: UseFormReturn<RadioFormValues> }) => {
  return (
    <div className="space-y-6 max-w-4xl w-full">
      <h2 className="text-lg font-semibold">Product Information</h2>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <FormField
          name="properties.station"
          control={form.control}
          render={({ field }) => (
            <FormItem>
              <FormLabel>Station Name</FormLabel>
              <FormControl>
                <Input placeholder="Station" {...field} className="rounded-sm py-5" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="107.8 " {...field} className="rounded-sm py-5" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
