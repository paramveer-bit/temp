...
import image from '@/../public/onboarding/step2.png';
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-primary via-primary to-blue-900 flex-col p-8 relative overflow-hidden">
        ...
        {/* Text Content */}
        <div className="text-center text-white relative z-10 max-w-sm mx-auto">
        ...
        {/* Decorative shapes */}
        <div className="absolute bottom-8 right-12 w-16 h-16 rounded-lg transform rotate-45 opacity-40 bg-[#FF7B42]" />
      </div>
      ...
      <div className="w-full lg:w-1/2 bg-secondary flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 flex items-center justify-between">
            <button
              className="text-foreground hover:opacity-70 transition flex items-center gap-2 font-medium"
          ...
          {/* Form Title */}
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-foreground leading-tight">Verify your email</h2>
            <p className="text-foreground/60 mt-2">Enter the OTP sent to your email address</p>
          </div>
